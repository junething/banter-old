// https://stackoverflow.com/a/29605146
...
/** Check if the string matches the cases argument for the first n chars (case sensitive) */
#define cases_n(x, n)    } if ( __cont || !strncmp ( __sw, x, n ) ) \
                        { __done = true; __cont = true;
